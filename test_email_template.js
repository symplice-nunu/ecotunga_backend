...
const testApprovalData = {
  ...
  bookingDate: 'Monday, December 23, 2024',
...
// Create the email template function (copied from emailService.js)
          ...
          <div class="section">
              ...
              <table style="width: 100%; max-width: 400px; margin: 0 auto; display: block;">
                <tr>
                  <td style="text-align: center; padding: 10px;">
                    <a href="http://localhost:3000/recycling-center/bookings/${bookingId}/confirm?action=accept" 
                  ...
                  <td style="text-align: center; padding: 10px;">
                    <a href="http://localhost:3000/recycling-center/bookings/${bookingId}/confirm?action=decline" 
            ...
            <div style="margin-top: 20px; padding: 15px; background-color: #f1f5f9; border-radius: 5px; border-left: 4px solid #64748b;">
              <p style="margin: 0; color: #475569; font-size: 13px;">
                ...
                <a href="http://localhost:3000/recycling-center/bookings/${bookingId}/confirm?action=accept" style="color: #10B981; text-decoration: underline;">Accept Price</a> | 
                <a href="http://localhost:3000/recycling-center/bookings/${bookingId}/confirm?action=decline" style="color: #EF4444; text-decoration: underline;">Decline Price</a>
              </p>
            </div>
...
const emailHTML = createApprovalEmailTemplate(testApprovalData);

// Save to file for preview
const outputPath = path.join(__dirname, 'email_preview.html');
fs.writeFileSync(outputPath, emailHTML);

console.log('✅ Email template generated successfully!');
console.log(`📧 Preview saved to: ${outputPath}`);
console.log('🌐 Open the HTML file in your browser to see how the email will look');
console.log('\n📋 Email features:');
console.log('   - Professional styling with green theme');
console.log('   - Price highlight section');
console.log('   - Accept/Decline buttons with proper styling');
